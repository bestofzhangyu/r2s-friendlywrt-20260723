...
3. **触发编译**：
   ...
   - 点击 **"Run workflow"**
   - 可选择分支版本（`master-v23.05` 稳定版 或 `master-v24.10` 新版）
...
### 源码来源
- **FriendlyWrt**: `https://github.com/friendlyarm/friendlywrt_manifests` (分支: master-v23.05)
- **passwall + passwall2**: `https://github.com/xiaorouji/openwrt-passwall` (分支: main)
...
- 支持: FriendlyWrt 23.05 / 24.10, 内核 6.6
